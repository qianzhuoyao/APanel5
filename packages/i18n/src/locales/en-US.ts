export const enUS = {
  ...
  panel: {
    ...
    config: {
      ...
      tableRowsEditDesc: "Edit a JSON array below. Format is validated before save.",
      tableRowsEditEditorHint: "Tab indents; use Format to pretty-print JSON.",
      ...
      tableValueMapHint:
        "Replace raw values with friendly labels, e.g. status = ok → Normal. Unmatched values stay unchanged.",
      ...
      tableDisplayValueHint: "Text shown when the mapping matches (replaces the raw value).",
