...
// ../../node_modules/.pnpm/infinite-viewer@0.29.1/node_modules/infinite-viewer/dist/infinite-viewer.esm.js
...
function measureSpeed(e) {
  var deltaX = e.deltaX, deltaY = e.deltaY, datas = e.datas;
  var time = Date.now();
...
var ScrollBar = function(_super) {
  ...
  function ScrollBar2(containerElement, type, container) {
    ...
    _this._onDragStart = function(e) {
      var isHorizontal2 = _this.isHorizontal;
      ...
      if (!isThumb) {
        setTimeout(function() {
          requestAnimationFrame(function() {
            ...
            var pos1 = thumbRect[isHorizontal2 ? "left" : "top"];
            var thumbSize = thumbRect[isHorizontal2 ? "width" : "height"];
            var pos2 = pos1 + thumbSize;
            var clientPos = e[isHorizontal2 ? "clientX" : "clientY"];
  ...
  var __proto = ScrollBar2.prototype;
  ...
  __proto.render = function(isDisplay, pos, size, scrollSize) {
    ...
    var opacity = isDisplay && throttle(scrollSize - size, 1e-3) > 0 ? 1 : 0;
    var _a = this.isHorizontal ? ["X", "width"] : ["Y", "height"], dirName1 = _a[0], sizeName = _a[1];
...
var InfiniteViewer = function(_super) {
  __extends(InfiniteViewer3, _super);
  function InfiniteViewer3(_containerElement, viewportElement, options) {
    ...
    _this.resize = function() {
      var _a = _this._containerElement, containerWidth = _a.offsetWidth, containerHeight = _a.offsetHeight;
      var _b = _this._viewportElement, viewportWidth = _b.offsetWidth, viewportHeight = _b.offsetHeight, viewportScrollWidth = _b.scrollWidth, viewportScrollHeight = _b.scrollHeight;
    ...
    _this._onScroll = function() {
      var _a = _this.wrapperElement, scrollLeft = _a.scrollLeft, scrollTop = _a.scrollTop;
      var _b = _this.zoom, zoom = _b === void 0 ? DEFAULT_OPTIONS.zoom : _b;
    ...
    _this.onWheel = function(e) {
      ...
      var pinchDirection = options2.pinchDirection;
      var maxPinchWheel = options2.maxPinchWheel || Infinity;
      var isKeydown = e["".concat(_this.wheelPinchKey, "Key")] || e.ctrlKey;
      if (options2.useWheelPinch && isKeydown) {
        var deltaY = e.deltaY;
        var sign = deltaY >= 0 ? 1 : -1;
        var distance = Math.min(maxPinchWheel, Math.abs(deltaY));
        deltaY = sign * distance;
        var delta = -deltaY;
        var scale = Math.max(1 + delta * (options2.wheelScale || 0.01), TINY_NUM);
      ...
      } else if (options2.useWheelScroll) {
        var deltaX = e.deltaX;
        var deltaY = e.deltaY;
  ...
  var __proto = InfiniteViewer3.prototype;
  ...
  __proto.setTo = function(options) {
    var _a = options.x, x = _a === void 0 ? this.getScrollLeft() : _a, _b = options.y, y = _b === void 0 ? this.getScrollTop() : _b, _c = options.zoom, zoom = _c === void 0 ? [this.getZoomX(), this.getZoomY()] : _c, duration = options.duration;
    var _d = this, prevZoomX = _d.zoomX, prevZoomY = _d.zoomY, zoomRange = _d.zoomRange;
    var _e = this, _f = _e.zoomOffsetX, zoomOffsetX = _f === void 0 ? DEFAULT_OPTIONS.zoomOffsetX : _f, _g = _e.zoomOffsetY, zoomOffsetY = _g === void 0 ? DEFAULT_OPTIONS.zoomOffsetY : _g;
    ...
    var _h = isArray(zoom) ? zoom : [zoom, zoom], zoomX = _h[0], zoomY = _h[1];
  ...
  __proto.setBy = function(options) {
    var _a = options.x, x = _a === void 0 ? 0 : _a, _b = options.y, y = _b === void 0 ? 0 : _b, _c = options.zoom, zoom = _c === void 0 ? [0, 0] : _c;
    var _d = isArray(zoom) ? zoom : [zoom, zoom], zoomX = _d[0], zoomY = _d[1];
  ...
  __proto.zoomBy = function(deltaZoom, options) {
    ...
    var _a = isArray(deltaZoom) ? deltaZoom : [deltaZoom, deltaZoom], deltaX = _a[0], deltaY = _a[1];
    if (!options || !options.duration) {
  ...
  __proto.setZoom = function(zoom, options) {
    ...
    if (!options || !options.duration) {
      ...
      var _a = isArray(zoom) ? zoom : [zoom, zoom], zoomX = _a[0], zoomY = _a[1];
  ...
  __proto.init = function() {
    ...
    var doc = getDocument(containerElement);
    var win = getWindow(containerElement);
    ...
    this.gesto = new Gesto(containerElement, {
      ...
      var inputEvent = e.inputEvent, stop = e.stop, datas = e.datas;
    ...
    }).on("pinchStart", function(_a2) {
      var inputEvent = _a2.inputEvent, datas = _a2.datas, stop = _a2.stop;
      inputEvent.preventDefault();
      _this._pauseScrollAnimation();
  ...
  __proto.render = function() {
    var _a = this, offsetX = _a.offsetX, offsetY = _a.offsetY, _b = _a.zoomX, zoomX = _b === void 0 ? DEFAULT_OPTIONS.zoomX : _b, _c = _a.zoomY, zoomY = _c === void 0 ? DEFAULT_OPTIONS.zoomY : _c, _d = _a.translateZ, translateZ = _d === void 0 ? 0 : _d, rangeX = _a.rangeX, rangeY = _a.rangeY, containerWidth = _a.containerWidth, containerHeight = _a.containerHeight;
    var _e = this.options.useTransform, useTransform = _e === void 0 ? DEFAULT_OPTIONS.useTransform : _e;
    ...
    if (useTransform === false) {
      viewportStyle.cssText += "position: relative; left: ".concat(nextOffsetX, "px; top: ").concat(nextOffsetY, "px; ");
    } else {
  ...
  __proto.renderScroll = function() {
    var _a = this, zoomX = _a.zoomX, zoomY = _a.zoomY, containerWidth = _a.containerWidth, containerHeight = _a.containerHeight;
  ...
  __proto.getScrollAreaWidth = function() {
    var _a = this.getRangeX(true), min = _a[0], max = _a[1];
    return min || max ? this.margin * 2 : 0;
  };
  __proto.getScrollAreaHeight = function() {
    var _a = this.getRangeY(true), min = _a[0], max = _a[1];
    return min || max ? this.margin * 2 : 0;
  };
  __proto._triggerPinch = function(event) {
    var clientX = event.clientX, clientY = event.clientY, zoomX = event.zoomX, zoomY = event.zoomY;
    if (this.useAutoZoom) {
    ...
    var zoomRangeX = this.zoomRangeX || zoomRange;
    var zoomRangeY = this.zoomRangeY || zoomRange;
    var _a = this._tempRect, left = _a.left, top = _a.top, width = _a.width, height = _a.height;
  ...
  __proto._setZoom = function(zoom, zoomOptions) {
    ...
    var _a = this, containerWidth = _a.containerWidth, containerHeight = _a.containerHeight, prevZoomX = _a.zoomX, prevZoomY = _a.zoomY, zoomRange = _a.zoomRange;
    var _b = this, _c = _b.zoomOffsetX, zoomOffsetX = _c === void 0 ? DEFAULT_OPTIONS.zoomOffsetX : _c, _d = _b.zoomOffsetY, zoomOffsetY = _d === void 0 ? DEFAULT_OPTIONS.zoomOffsetY : _d;
    ...
    var scrollLeft = this.getScrollLeft();
    var scrollTop = this.getScrollTop();
    var _e = isArray(zoom) ? zoom : [zoom, zoom], zoomX = _e[0], zoomY = _e[1];
    var zoomRangeX = this.zoomRangeX || zoomRange;
    var zoomRangeY = this.zoomRangeY || zoomRange;
    var nextZoomX = between(zoomX, zoomRangeX[0], zoomRangeX[1]);
    var nextZoomY = between(zoomY, zoomRangeY[0], zoomRangeY[1]);
  ...
  __proto._scrollTo = function(x, y, options) {
    var _this = this;
    var _a = this, prevScrollLeft = _a.scrollLeft, prevScrollTop = _a.scrollTop;
    ...
    if (Math.round(prevScrollLeft) !== scrollLeft || Math.round(prevScrollTop) !== scrollTop) {
      ...
      requestAnimationFrame(function() {
        ...
        _this.isLoop = false;
        var _a2 = _this.wrapperElement, requestScrollLeft = _a2.scrollLeft, requestScrollTop = _a2.scrollTop;
  ...
  __proto._scrollToType = function(type, coord, isAbsolute) {
    ...
    var _a = this, _b = _a.margin, margin = _b === void 0 ? DEFAULT_OPTIONS.margin : _b, _c = _a.threshold, threshold = _c === void 0 ? DEFAULT_OPTIONS.threshold : _c;
    var prevScrollPos = this["scroll".concat(names.pos)];
    var _d = this["getRange".concat(names.coord)](true, true), minCoord = _d[0], maxCoord = _d[1];
  ...
  __proto._getRangeCoord = function(type, isZoom, isReal) {
    var _a = this, _b = _a.margin, margin = _b === void 0 ? DEFAULT_OPTIONS.margin : _b, threshold = _a.threshold;
    var names = NAMES[type];
  ...
  return InfiniteViewer3;
}(event_emitter_esm_default);
var InfiniteViewer$1 = function(_super) {
  __extends(InfiniteViewer3, _super);
  function InfiniteViewer3() {
    return _super !== null && _super.apply(this, arguments) || this;
  }
  return InfiniteViewer3;
}(InfiniteViewer);
var infinite_viewer_esm_default = InfiniteViewer$1;
...
var InfiniteViewer2 = function(_super) {
  __extends2(InfiniteViewer3, _super);
  function InfiniteViewer3() {
    return _super !== null && _super.apply(this, arguments) || this;
  }
  var __proto = InfiniteViewer3.prototype;
  __proto.render = function() {
    ...
    return (0, import_react.createElement)("div", {
      className: "".concat(className || "", " ").concat(CLASS_NAME),
    ...
    }), this.props.children), (0, import_react.createElement)("div", {
  ...
  __proto.componentDidMount = function() {
    ...
    this.infiniteViewer = new infinite_viewer_esm_default(this.containerElement, this.scrollAreaElement.nextElementSibling, __assign2(__assign2({}, options), {
  ...
  __decorate2([withMethods(METHODS)], InfiniteViewer3.prototype, "infiniteViewer", void 0);
  return InfiniteViewer3;
}(import_react.PureComponent);
var infinite_viewer_esm_default2 = InfiniteViewer2;
export {
  CLASS_NAME,
  EVENTS,
  METHODS,
  OPTIONS,
  PROPERTIES,
  infinite_viewer_esm_default2 as default
};
//# sourceMappingURL=react-infinite-viewer.js.map
