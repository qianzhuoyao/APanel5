...
// ../../node_modules/.pnpm/@react-three+cannon@6.6.0_@react-three+fiber@8.18.0_react@19.2.0_three@0.172.0_typescript@5.5.4/node_modules/@react-three/cannon/dist/index.js
...
var propsToBody = (options) => {
  ...
  if (type === "Compound") {
    shapes.forEach((_ref4) => {
      ...
      if (material2) shapeBody.material = createMaterial(material2);
