...
// ../../node_modules/.pnpm/react-zoom-pan-pinch@4.0.3_react-dom@19.2.0_react@19.2.0/node_modules/react-zoom-pan-pinch/dist/index.esm.js
...
var TransformWrapper = import_react.default.forwardRef(function(props, ref) {
  ...
  return (0, import_jsx_runtime.jsx)(Context.Provider, __assign({ value: instance }, { children: content }));
});
var KeepScale = import_react.default.forwardRef(function(props, ref) {
  ...
  return (0, import_jsx_runtime.jsx)("div", __assign({}, props, { ref: mergeRefs([localRef, ref]) }));
});
...
var MiniMap = function(_a) {
  var _b = _a.width, width = _b === void 0 ? 200 : _b, _c = _a.height, height = _c === void 0 ? 200 : _c, _d = _a.borderColor, borderColor = _d === void 0 ? "red" : _d, previewStyle = _a.previewStyle, wrapperClassName = _a.wrapperClassName, previewClassName = _a.previewClassName, children = _a.children, _e = _a.panning, panning = _e === void 0 ? true : _e, rest = __rest(_a, ["width", "height", "borderColor", "previewStyle", "wrapperClassName", "previewClassName", "children", "panning"]);
  var _f = (0, import_react.useState)(false), initialized = _f[0], setInitialized = _f[1];
  var instance = useTransformContext();
  var _g = (0, import_react.useState)(false), isDown = _g[0], setIsDown = _g[1];
  ...
  var computeMiniMapStyle = function() {
    ...
    if (wrapperRef.current) {
      var el = wrapperRef.current.style;
  ...
  var transformMiniMap = function() {
    ...
    if (previewRef.current) {
      ...
      var scale = computeMiniMapScale();
      var previewScale = scale * (1 / instance.state.scale);
      var transform = instance.handleTransformStyles(-instance.state.positionX * previewScale, -instance.state.positionY * previewScale, 1);
  ...
  (0, import_react.useEffect)(function() {
    return instance.onChange(function(zpp) {
      ...
      if (miniMapInstance.current) {
        ...
        miniMapInstance.current.instance.state.positionX = zpp.instance.state.positionX * scale;
        miniMapInstance.current.instance.state.positionY = zpp.instance.state.positionY * scale;
      }
    });
  ...
  (0, import_react.useEffect)(function() {
    var move = function(e) {
      var _a2, _b2;
      if (panning && isDown && instance.contentComponent && previewRef.current && mainRef.current) {
        var scale = computeMiniMapScale();
        var previewRect = previewRef.current.getBoundingClientRect();
        var mainRect = mainRef.current.getBoundingClientRect();
        var relativeX = (e.clientX - mainRect.left) / scale;
        var relativeY = (e.clientY - mainRect.top) / scale;
        var x = relativeX - previewRect.width / 2;
        var y = relativeY - previewRect.height / 2;
        var instanceWidth = (((_a2 = instance.wrapperComponent) === null || _a2 === void 0 ? void 0 : _a2.offsetWidth) || 0) * instance.state.scale;
        var instanceHeight = (((_b2 = instance.wrapperComponent) === null || _b2 === void 0 ? void 0 : _b2.offsetHeight) || 0) * instance.state.scale;
        var limitWidth = instanceWidth - previewRect.width * 2 * instance.state.scale;
        var limitHeight = instanceHeight - previewRect.height * 2 * instance.state.scale;
        var boundedX = boundLimiter(x * instance.state.scale, 0, limitWidth, true);
        var boundedY = boundLimiter(y * instance.state.scale, 0, limitHeight, true);
        instance.setState(instance.state.scale, -boundedX, -boundedY);
      }
    };
    var setDown = function(e) {
      var _a2;
      if (((_a2 = mainRef.current) === null || _a2 === void 0 ? void 0 : _a2.contains(e.target)) || e.target === mainRef.current) {
        move(e);
        setIsDown(true);
      }
    };
  ...
  return (0, import_jsx_runtime.jsxs)("div", __assign({}, rest, { ref: mainRef, style: wrapperStyle, className: "rzpp-mini-map ".concat(rest.className || "").trim() }, { children: [(0, import_jsx_runtime.jsx)("div", __assign({ style: { pointerEvents: "none" }, ref: wrapperRef, className: "rzpp-minimap-wrapper ".concat(wrapperClassName || "").trim() }, { children })), (0, import_jsx_runtime.jsx)("div", { className: "rzpp-minimap-preview ".concat(previewClassName || "").trim(), ref: previewRef, style: __assign(__assign(__assign({}, previewStyles), { borderColor }), previewStyle) })] }));
};
...
var TransformComponent = function(_a) {
  ...
  var gridRef = (0, import_react.useRef)(null);
  (0, import_react.useEffect)(function() {
  ...
  return (0, import_jsx_runtime.jsxs)("div", __assign({}, wrapperProps, { ref: wrapperRef, className: "".concat(baseClasses.wrapperClass, " ").concat(styles.wrapper, " ").concat(wrapperClass), style: wrapperStyle }, { children: [infinite && (0, import_jsx_runtime.jsx)("div", { ref: gridRef, className: styles.infiniteGrid, "aria-hidden": true }), (0, import_jsx_runtime.jsx)("div", __assign({}, contentProps, { ref: contentRef, className: "".concat(baseClasses.contentClass, " ").concat(styles.content, " ").concat(contentClass), style: __assign(__assign({}, contentStyle), { transform: getTransformStyles(instance.state.positionX, instance.state.positionY, instance.state.scale) }) }, { children }))] }));
};
...
var Virtualize = import_react.default.forwardRef(function(_a, ref) {
  ...
  var instance = (0, import_react.useContext)(Context);
  var _e = (0, import_react.useState)(false), visible = _e[0], setVisible = _e[1];
  var visibleRef = (0, import_react.useRef)(false);
  var onShowRef = (0, import_react.useRef)(onShow);
  var onHideRef = (0, import_react.useRef)(onHide);
  ...
  if (!visible) {
    return placeholder ? (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: placeholder }) : null;
  }
  return (0, import_jsx_runtime.jsx)("div", __assign({ ref, className, style }, { children }));
});
